...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="logo-wrapper">
                <a class="logo" href="index-2.html"> <img src="front/img/logo-light.png" class="logo-img" alt=""> </a>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Home <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="index-2.html" class="dropdown-item"><span>Slider</span></a></li>
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Cars <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="car-details.html" class="dropdown-item active"><span>Car Details 01</span></a></li>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="5" data-background="front/img/slider/11.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="col-md-12">
                    <h6>Luxury Cars</h6>
                    ...
                    <div class="row gallery-items mb-60">
                        <div class="col-md-6 gallery-masonry-wrapper single-item cardio">
                            <a href="img/slider/11b.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                                <div class="gallery-box">
                                    <div class="gallery-img"> <img src="front/img/slider/11b.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                        ...
                        <div class="col-md-6 gallery-masonry-wrapper single-item crossfit">
                            <a href="img/slider/11a.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                                <div class="gallery-box">
                                    <div class="gallery-img"> <img src="img/slider/11a.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                                    <div class="gallery-masonry-item-img"></div>
                                </div>
                            </a>
                        </div>
    ...
    <script src="https://example.com/js/jquery-3.7.1.min.js"></script>
    <script src="https://example.com/js/jquery-migrate-3.4.1.min.js"></script>
    <script src="https://example.com/js/modernizr-2.6.2.min.js"></script>
    <script src="https://example.com/js/imagesloaded.pkgd.min.js"></script>
    <script src="https://example.com/js/jquery.isotope.v3.0.2.js"></script>
    <script src="https://example.com/js/popper.min.js"></script>
    <script src="https://example.com/js/bootstrap.min.js"></script>
    <script src="https://example.com/js/scrollIt.min.js"></script>
    <script src="https://example.com/js/jquery.waypoints.min.js"></script>
    <script src="https://example.com/js/owl.carousel.min.js"></script>
    <script src="https://example.com/js/jquery.stellar.min.js"></script>
    <script src="https://example.com/js/jquery.magnific-popup.js"></script>
    <script src="https://example.com/js/select2.js"></script>
    <script src="https://example.com/js/YouTubePopUp.js"></script>
    <script src="https://example.com/js/custom.js"></script>
